...
final class TestHttpProvider extends AbstractProvider {
	...
	public function get_id(): string { return 'test-provider'; }
	public function get_label(): string { return 'Test Provider'; }
	public function get_api_version(): string { return 'v1'; }
	public function validate_credentials(): ProviderResult { return ProviderResult::ok( true ); }
	public function get_capabilities(): array { return array(); }
	public function get_actions( string $provider_instance_id, array $settings ): array { return array(); }
	public function provision( ProvisionRequest $request ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function destroy( string $provider_instance_id ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function power_on( string $provider_instance_id ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function power_off( string $provider_instance_id ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function reboot( string $provider_instance_id ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function rebuild( string $provider_instance_id, string $image_id ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function get_instance_status( string $provider_instance_id ): ProviderResult { return ProviderResult::fail( 'unsupported', 'Not used.' ); }
	public function get_available_plans( ?string $region_slug = null ): ProviderResult { return ProviderResult::ok( array() ); }
	public function get_available_regions(): ProviderResult { return ProviderResult::ok( array() ); }
	public function get_available_images(): ProviderResult { return ProviderResult::ok( array() ); }
